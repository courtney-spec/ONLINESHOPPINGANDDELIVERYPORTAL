...
<head>
    ...
    <title>Add Product — StyleHub</title>
...
<div class="ml-64 flex-1">
    <header class="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-30">
        <div class="flex items-center gap-3">
            ...
            <h1 class="font-display font-semibold text-gray-900 text-lg">Add New Product</h1>
        </div>
    </header>
    <main class="p-6 max-w-3xl">
        ...
        <form method="POST" action="{{ route('product_manager.products.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                           ...
                           class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('name') border-red-400 @enderror">
                </div>
                ...
                <div>
                    ...
                    <select name="category_id" required
                            class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('category_id') border-red-400 @enderror">
                    ...
                    <a href="{{ route('product_manager.categories.create') }}" class="text-xs text-blue-600 hover:underline mt-1 inline-block">+ Add new category</a>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="price" value="{{ old('price') }}" required min="0" step="0.01"
                           ...
                           class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('price') border-red-400 @enderror">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="stock" value="{{ old('stock', 0) }}" required min="0"
                           placeholder="e.g. 50"
                           class="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 @error('stock') border-red-400 @enderror">
                </div>
